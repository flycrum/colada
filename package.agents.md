...
- **fast-json-patch** — RFC 6902 JSON Patch; used by [scripts/sync-claude-marketplace.js](./scripts/sync-claude-marketplace.js) for surgical edits to `.claude-plugin/marketplace.json` and `.claude/settings.json`
