...
- Platform: [claude-code-intricacies.md](./claude-code-intricacies.md), [cursor-intricacies.md](./cursor-intricacies.md). Other agents: [other-agent-intricacies.md](./other-agent-intricacies.md)
